...
if __name__ == '__main__':
    """
    Main evaluation script for the Franka Kitchen hinge_cabinet task.
    ...
    - evaluates the learned policy on the hinge_cabinet task.
    """
    ...
    # Policy Evaluation             #
    # ----------------------------- #
    # Run the trained hinge cabinet policy for 3 evaluation episodes
